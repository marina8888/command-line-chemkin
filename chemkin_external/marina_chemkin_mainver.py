...
# ________________________________________________________________________________________________________________
#input values to be used in the input script:
...
#write to a final solution file defining all the parameters used:
...
def main():
    ...
    while u <= Umax and last < 2:  # While u of iteration iter is smaller than Umax and that there is no error finishing calculation
        ...
        ### 3.1.0 For iteration ite, create input (.inp) file and launch chemkin_external
